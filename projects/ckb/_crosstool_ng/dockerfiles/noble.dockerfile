...
RUN echo 'Acquire::http::Proxy "http://192.168.1.247:31082";' > /etc/apt/apt.conf.d/proxy
RUN echo 'Acquire::https::Proxy "http://192.168.1.247:31082";' >> /etc/apt/apt.conf.d/proxy
